 ...
 * often on cellular data, more likely to call than to fill out a form. This
 ...
 * (intake question 5). A "Text Us" button pointing at a landline sends
 * messages into a void, which is worse than not offering it.
 */
export function StickyCallBar() {
  const canText = Boolean(DEALER.smsHref)
    ...
    >
      <div className="flex gap-2 p-2">
        ...
        <a
          ...
          className={`flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-md bg-red px-3 text-sm font-bold text-cream ${canText ? 'flex-[2]' : 'flex-1'}`}
        >
